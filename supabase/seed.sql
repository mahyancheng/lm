...
-- ---------------------------------------------------------------------------
-- Flagship products
-- price_usd is per seat per QUARTER and seats x price x 4 = arr_usd, matching
-- the engine's scenario/demo.ts economics exactly (post revenue-continuity fix).
-- ---------------------------------------------------------------------------
...
insert into public.products (
  ...
  ('15000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000001',
   ...
   1760.00, 'per_seat', 0.91, 0.84, 0.985, 0.0000041, 1051136, 4200, 7400000000, 0.07,
  ...
  ('15000000-0000-4000-8000-000000000002', '00000000-0000-4000-8000-000000000001',
   ...
   350.00, 'per_seat', 0.74, 0.89, 0.997, 0.31, 3500000, 2600, 4900000000, 0.04,
  ...
  ('15000000-0000-4000-8000-000000000003', '00000000-0000-4000-8000-000000000001',
   ...
   6240.00, 'per_seat', 0.55, 0.92, 0.9995, 1.44, 244391, 310, 6100000000, 0.02,
  ...
  ('15000000-0000-4000-8000-000000000004', '00000000-0000-4000-8000-000000000001',
   ...
   375.00, 'per_seat', 0.68, 0.81, 0.991, 0.22, 460000, 480, 690000000, 0.14,
  ...
  ('15000000-0000-4000-8000-000000000005', '00000000-0000-4000-8000-000000000001',
   ...
   28500.00, 'per_seat', 0.87, 0.94, 0.999, 0, 129824, 92, 14800000000, 0.01,
  ...
  ('15000000-0000-4000-8000-000000000006', '00000000-0000-4000-8000-000000000001',
   ...
   1460.00, 'per_seat', 0.63, 0.86, 0.994, 0.09, 140410, 140, 820000000, 0.06,

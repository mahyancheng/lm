...
managed Codex login and persistent threads survive restarts, and your players
...
- **Codex status**: run `sudo -u www-data CODEX_HOME=/var/lib/frontier-capital/codex-home codex login status`.

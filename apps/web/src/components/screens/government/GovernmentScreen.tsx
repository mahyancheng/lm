...
export function GovernmentScreen(): React.JSX.Element {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-2.5 sm:gap-3 lg:grid-cols-4">
        ...
        <StatCard iconName="ledger" label="Backlog" value={formatMoney(backlog)} hint={`${contracts.length} live contract${contracts.length === 1 ? '' : 's'}`} href={sheetHref('financials')} />
        <StatCard
          iconName="warning"
          label="Compliance"

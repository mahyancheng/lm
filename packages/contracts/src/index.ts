 ...
 * | `nodeRoles`   | World 3: the substitution classes a slot is typed against   |
 * | `nodes`       | World 3: the node schema, slots, markets, graph integrity    |
 * | `nodeGraph`   | World 3: the node table itself, ninety-seven rows           |

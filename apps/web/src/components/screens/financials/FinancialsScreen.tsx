...
export function FinancialsScreen(): React.JSX.Element {
  ...
  const balanceRows: StatementRow[] = [
    ...
    { key: 'goodwill', label: 'Goodwill', value: formatMoney(company.balanceSheet.assets.goodwill), indent: true },
    {
      ...
      label: (
        <Link href={sheetHref('portfolio')} className="hover:text-brand">
          Investments
        </Link>
      ),
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Link href={sheetHref('capital')} className="btn tap-target gap-1.5">

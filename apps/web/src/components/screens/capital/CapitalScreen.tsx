...
export function CapitalScreen(): React.JSX.Element {
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap items-center gap-2">
        <Link href={sheetHref('financials')} className="btn btn-sm tap-target sm:min-h-0">
          Financials
        </Link>
        <Link href={sheetHref('boardroom')} className="btn btn-sm tap-target sm:min-h-0">
          Boardroom
        </Link>
      </div>

...
export function ProductsScreen(): React.JSX.Element {
  ...
  // `?sheet=products&line=<productId>` — the Company tab's Connections card
  // names a line on the way in. Read above the branch, because a hook may not
  // sit below a return; worlds 1 and 2 never had the card and ignore it.
  ...
  // always had.
  if (isNodeEconomyWorld(session)) return <ConnectionsScreen initialLineId={initialLineId} />;

...
export const W3_BACKGROUND_OPENINGS: Readonly<Record<BackgroundId, Readonly<Record<Region, W3OpeningFacts>>>> = {
  frontier_lab: {
    north_america: { cashUsd: 15000000, revenueUsd: 0, unitPriceUsd: 50868796.9 },
    europe: { cashUsd: 15000000, revenueUsd: 0, unitPriceUsd: 50868796.9 },
    east_asia: { cashUsd: 15000000, revenueUsd: 0, unitPriceUsd: 50868796.9 },
    south_asia: { cashUsd: 15000000, revenueUsd: 0, unitPriceUsd: 50868796.9 },
    middle_east: { cashUsd: 15000000, revenueUsd: 0, unitPriceUsd: 50868796.9 },
    latin_america: { cashUsd: 15000000, revenueUsd: 0, unitPriceUsd: 50868796.9 },
  },
  enterprise_ai: {
    north_america: { cashUsd: 10069413, revenueUsd: 3840063.45, unitPriceUsd: 2501.67 },
    europe: { cashUsd: 4000000, revenueUsd: 3840063.45, unitPriceUsd: 2501.67 },
    east_asia: { cashUsd: 4000000, revenueUsd: 3637428.18, unitPriceUsd: 2501.67 },
    south_asia: { cashUsd: 4000000, revenueUsd: 2354071.47, unitPriceUsd: 2501.67 },
    middle_east: { cashUsd: 4000000, revenueUsd: 3840063.45, unitPriceUsd: 2501.67 },
    latin_america: { cashUsd: 4000000, revenueUsd: 2781857.04, unitPriceUsd: 2501.67 },
  },
  consumer_ai: {
    north_america: { cashUsd: 5000000, revenueUsd: 7949424, unitPriceUsd: 16 },
    europe: { cashUsd: 5000000, revenueUsd: 6420688, unitPriceUsd: 16 },
    east_asia: { cashUsd: 5000000, revenueUsd: 6000000, unitPriceUsd: 16 },
    south_asia: { cashUsd: 5000000, revenueUsd: 6000000, unitPriceUsd: 16 },
    middle_east: { cashUsd: 5000000, revenueUsd: 6000000, unitPriceUsd: 16 },
    latin_america: { cashUsd: 5000000, revenueUsd: 6000000, unitPriceUsd: 16 },
  },
  infrastructure: {
    north_america: { cashUsd: 7877945, revenueUsd: 15978654.01, unitPriceUsd: 840981.79 },
    europe: { cashUsd: 6000000, revenueUsd: 13727523.04, unitPriceUsd: 857970.19 },
    east_asia: { cashUsd: 6000000, revenueUsd: 12705331.65, unitPriceUsd: 847022.11 },
    south_asia: { cashUsd: 6000000, revenueUsd: 12569424.45, unitPriceUsd: 837961.63 },
    middle_east: { cashUsd: 6000000, revenueUsd: 12246644.85, unitPriceUsd: 816442.99 },
    latin_america: { cashUsd: 6000000, revenueUsd: 12524122.05, unitPriceUsd: 834941.47 },
  },
  bootstrapper: {
    north_america: { cashUsd: 5276021, revenueUsd: 1944031.03, unitPriceUsd: 1556.47 },
    europe: { cashUsd: 2244521, revenueUsd: 1944031.03, unitPriceUsd: 1556.47 },
    east_asia: { cashUsd: 1200000, revenueUsd: 1909788.69, unitPriceUsd: 1556.47 },
    south_asia: { cashUsd: 1200000, revenueUsd: 1235837.18, unitPriceUsd: 1556.47 },
    middle_east: { cashUsd: 1200000, revenueUsd: 1944031.03, unitPriceUsd: 1556.47 },
    latin_america: { cashUsd: 1200000, revenueUsd: 1459968.86, unitPriceUsd: 1556.47 },
  },
  warehouse_robotics: {
    north_america: { cashUsd: 7000000, revenueUsd: 9080233.92, unitPriceUsd: 55367.28 },
    europe: { cashUsd: 7000000, revenueUsd: 7364670.18, unitPriceUsd: 55373.46 },
    east_asia: { cashUsd: 7000000, revenueUsd: 5979903.84, unitPriceUsd: 55369.48 },
    south_asia: { cashUsd: 7000000, revenueUsd: 3875632.6, unitPriceUsd: 55366.18 },
    middle_east: { cashUsd: 7000000, revenueUsd: 6643003.2, unitPriceUsd: 55358.36 },
    latin_america: { cashUsd: 7000000, revenueUsd: 4539937.38, unitPriceUsd: 55365.09 },
  },
  humanoid_lab: {
    north_america: { cashUsd: 58921831, revenueUsd: 0, unitPriceUsd: 130078.41 },
    europe: { cashUsd: 46747674, revenueUsd: 0, unitPriceUsd: 130083.55 },
    east_asia: { cashUsd: 37008616, revenueUsd: 0, unitPriceUsd: 130080.24 },
    south_asia: { cashUsd: 22399949, revenueUsd: 0, unitPriceUsd: 130077.49 },
    middle_east: { cashUsd: 41878538, revenueUsd: 0, unitPriceUsd: 130070.97 },
    latin_america: { cashUsd: 27269570, revenueUsd: 0, unitPriceUsd: 130076.58 },
  },
  contract_manufacturer: {
    north_america: { cashUsd: 17116534, revenueUsd: 14004000, unitPriceUsd: 9000 },
    europe: { cashUsd: 10995714, revenueUsd: 14004000, unitPriceUsd: 9000 },
    east_asia: { cashUsd: 9000000, revenueUsd: 14004000, unitPriceUsd: 9000 },
    south_asia: { cashUsd: 9000000, revenueUsd: 14004000, unitPriceUsd: 9000 },
    middle_east: { cashUsd: 9000000, revenueUsd: 14004000, unitPriceUsd: 9000 },
    latin_america: { cashUsd: 9000000, revenueUsd: 14004000, unitPriceUsd: 9000 },
  },
  precision_components: {
    north_america: { cashUsd: 5000000, revenueUsd: 3849650, unitPriceUsd: 850 },
    europe: { cashUsd: 5000000, revenueUsd: 3115250, unitPriceUsd: 850 },
    east_asia: { cashUsd: 5000000, revenueUsd: 2999650, unitPriceUsd: 850 },
    south_asia: { cashUsd: 5000000, revenueUsd: 2999650, unitPriceUsd: 850 },
    middle_east: { cashUsd: 5000000, revenueUsd: 2999650, unitPriceUsd: 850 },
    latin_america: { cashUsd: 5000000, revenueUsd: 2999650, unitPriceUsd: 850 },
  },
  grid_developer: {
    north_america: { cashUsd: 25376723, revenueUsd: 5672212.39, unitPriceUsd: 120685.37 },
    europe: { cashUsd: 25433468, revenueUsd: 4586044.06, unitPriceUsd: 120685.37 },
    east_asia: { cashUsd: 25400660, revenueUsd: 3741246.47, unitPriceUsd: 120685.37 },
    south_asia: { cashUsd: 25546957, revenueUsd: 2413707.4, unitPriceUsd: 120685.37 },
    middle_east: { cashUsd: 25612574, revenueUsd: 4103302.58, unitPriceUsd: 120685.37 },
    latin_america: { cashUsd: 25367851, revenueUsd: 2896448.88, unitPriceUsd: 120685.37 },
  },
  renewables_operator: {
    north_america: { cashUsd: 31943058, revenueUsd: 5572223.05, unitPriceUsd: 1114444.61 },
    europe: { cashUsd: 28855461, revenueUsd: 5574478.4, unitPriceUsd: 1114895.68 },
    east_asia: { cashUsd: 26398353, revenueUsd: 5573007.55, unitPriceUsd: 1114601.51 },
    south_asia: { cashUsd: 22708614, revenueUsd: 5571830.85, unitPriceUsd: 1114366.17 },
    middle_east: { cashUsd: 27645546, revenueUsd: 5569036.2, unitPriceUsd: 1113807.24 },
    latin_america: { cashUsd: 23941634, revenueUsd: 5571438.6, unitPriceUsd: 1114287.72 },
  },
  freight_network: {
    north_america: { cashUsd: 14650000, revenueUsd: 11621694.7, unitPriceUsd: 2.35 },
    europe: { cashUsd: 13504559, revenueUsd: 10999999.85, unitPriceUsd: 2.35 },
    east_asia: { cashUsd: 7673606, revenueUsd: 10999999.85, unitPriceUsd: 2.35 },
    south_asia: { cashUsd: 6000000, revenueUsd: 10999999.85, unitPriceUsd: 2.35 },
    middle_east: { cashUsd: 6000000, revenueUsd: 10999999.85, unitPriceUsd: 2.35 },
    latin_america: { cashUsd: 6000000, revenueUsd: 10999999.85, unitPriceUsd: 2.35 },
  },
  last_mile: {
    north_america: { cashUsd: 4000000, revenueUsd: 3200001, unitPriceUsd: 10.5 },
    europe: { cashUsd: 4000000, revenueUsd: 3200001, unitPriceUsd: 10.5 },
    east_asia: { cashUsd: 4000000, revenueUsd: 3200001, unitPriceUsd: 10.5 },
    south_asia: { cashUsd: 4000000, revenueUsd: 3200001, unitPriceUsd: 10.5 },
    middle_east: { cashUsd: 4000000, revenueUsd: 3200001, unitPriceUsd: 10.5 },
    latin_america: { cashUsd: 4000000, revenueUsd: 3200001, unitPriceUsd: 10.5 },
  },
  direct_brand: {
    north_america: { cashUsd: 5000000, revenueUsd: 4434618.75, unitPriceUsd: 1018.75 },
    europe: { cashUsd: 5000000, revenueUsd: 4000123.3, unitPriceUsd: 1020.7 },
    east_asia: { cashUsd: 5000000, revenueUsd: 4000321.8, unitPriceUsd: 1019.45 },
    south_asia: { cashUsd: 5000000, revenueUsd: 4000314.48, unitPriceUsd: 1018.41 },
    middle_east: { cashUsd: 5000000, revenueUsd: 3999755.78, unitPriceUsd: 1015.94 },
    latin_america: { cashUsd: 5000000, revenueUsd: 3999957.74, unitPriceUsd: 1018.06 },
  },
  retail_platform: {
    north_america: { cashUsd: 10000000, revenueUsd: 3296277, unitPriceUsd: 9 },
    europe: { cashUsd: 10000000, revenueUsd: 2662380, unitPriceUsd: 9 },
    east_asia: { cashUsd: 10000000, revenueUsd: 2600001, unitPriceUsd: 9 },
    south_asia: { cashUsd: 10000000, revenueUsd: 2600001, unitPriceUsd: 9 },
    middle_east: { cashUsd: 10000000, revenueUsd: 2600001, unitPriceUsd: 9 },
    latin_america: { cashUsd: 10000000, revenueUsd: 2600001, unitPriceUsd: 9 },
  },
};

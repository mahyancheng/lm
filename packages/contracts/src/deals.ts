  ...
  .discriminatedUnion('kind', [
    z
      .object({
        ...
        quantityPerQuarter: z.number().int().min(1).describe('Accelerators due each quarter after the first.'),
        initialQuantity: z.number().int().min(1).optional().describe('First instalment quantity; omit to use quantityPerQuarter. Duration includes this first instalment.'),
